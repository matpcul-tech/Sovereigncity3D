...
export const ZONES = [
 {id:1,name:'The Grind',x:0,y:800,ground:0x3d3a2e,accent:'#F2A33C',unlock:1,bh:[55,95]},
 {id:2,name:'Main Street',x:800,y:800,ground:0x3a4046,accent:'#7FB2D9',unlock:1,bh:[90,150]},
 {id:3,name:'Innovation Row',x:1600,y:0,ground:0x2c3a40,accent:'#52C7D9',unlock:3,bh:[150,230]},
 {id:4,name:'Sovereign District',x:0,y:0,ground:0x4a3c2e,accent:'#3FB8AF',unlock:1,bh:[60,110]},
 {id:5,name:'Capital Row',x:800,y:0,ground:0x2e3138,accent:'#C9CFD9',unlock:4,bh:[260,400]},
 {id:6,name:'The Skyline',x:1600,y:800,ground:0x35301f,accent:'#E8C064',unlock:3,bh:[80,120]}
];
...
export const FITS=['#F2A33C','#3FB8AF','#C96F4A','#5E7C99','#8FA98B','#B6657F','#D9D2C0','#7A6FB2'];
