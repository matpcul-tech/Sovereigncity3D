...
export const ZONES = [
 {id:1,name:'The Grind',x:0,y:800,ground:0x4A3C2E,buildingColor:0xB5622A,accent:'#F2A33C',unlock:1,bh:[55,95]},
 {id:2,name:'Main Street',x:800,y:800,ground:0x363D47,buildingColor:0x4A6E8A,accent:'#7FB2D9',unlock:1,bh:[90,150]},
 {id:3,name:'Innovation Row',x:1600,y:0,ground:0x253238,buildingColor:0x2A8A84,accent:'#52C7D9',unlock:3,bh:[150,230]},
 {id:4,name:'Sovereign District',x:0,y:0,ground:0x3E3020,buildingColor:0xA06030,accent:'#3FB8AF',unlock:1,bh:[60,110]},
 {id:5,name:'Capital Row',x:800,y:0,ground:0x252830,buildingColor:0x38404E,accent:'#C9CFD9',unlock:4,bh:[260,400]},
 {id:6,name:'The Skyline',x:1600,y:800,ground:0x302A18,buildingColor:0xC49020,accent:'#E8C064',unlock:3,bh:[80,120]}
];
...
export const FITS=['#E85D28','#1AA89C','#D4402A','#2E6A9E','#6A9E4A','#C03878','#E8C064','#6858B8'];
